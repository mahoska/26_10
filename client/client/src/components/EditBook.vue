...
export default {
  ...
  delete_book(){
    var self=this
      ...
      axios.delete('http://localhost:88/BOOK_SHOP/client/api/book/'+this.book_id+"/"+this.book_authors.length + "/"+this.book_ganres.length, this.config)
  ...
  computed:{
    book_id: function(){
      ...
      //alert(this.$route.params.book_id)
      var self = this
